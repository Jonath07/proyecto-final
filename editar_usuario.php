...
require 'vendor/autoload.php';
    ...
    $infoUsuario = $clase->mostrarPorID($_GET['id']);
?>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input type="text" name="inputNombre" class="form-control" value="<?php echo $infoUsuario['nombre_usuario'] ?>">
                                    </div>

                                    <div class="form-group m-b-20">
                                        <label>Apellidos <span class="text-danger">*</span></label>
                                        <input type="text" name="inputApellido" class="form-control" value="<?php echo $infoUsuario['apellido_usuario'] ?>">
                                    </div>

                                    <div class="form-group m-b-20">
                                        <label>Correo Electronico <span class="text-danger"></span></label>
                                        <input type="text" name="inputEmail" class="form-control" value="<?php echo $infoUsuario['email_usuario'] ?>">
                                    </div>

                                    <div class="form-group m-b-20">
                                        <label>Direccion <span class="text-danger"></span></label>
                                        <input type="text" name="inputDireccion" class="form-control" value="<?php echo $infoUsuario['direccion_usuario'] ?>">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input type="text" name="inputUsuario" class="form-control" value="<?php echo $infoUsuario['usuario'] ?>">
                                    </div>

                                    <div class="form-group m-b-20">
                                        <label>Contraseña de Usuario <span class="text-danger">*</span></label>
                                        <input type="password" name="inputPassword" class="form-control" value="<?php echo $infoUsuario['contrasena_usuario'] ?>">
                                    </div>
