...
require 'vendor/autoload.php';
    ...
    $infoCategoria = $clase->mostrarPorID($_GET['id']);
?>
...
<div class="content-page">
	<div class="content">
		<div class="container">
            ...
            <form action="./acc/ac_categoria.php" method="post">
                <div class="row">
                    <div class="col-sm-12">
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        <label>Nombres Categoria<span class="text-danger">*</span></label>
                                        <input type="hidden" name="inputID" class="form-control" value="<?php echo $infoCategoria['id_categoria'] ?>">
                                        <input type="text" name="inputNombre" class="form-control" value="<?php echo $infoCategoria['nombre_categoria'] ?>">
                                    </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="text-center p-20">
                            <a href="categorias.php" type="button" class="btn w-sm btn-danger waves-effect waves-light">Cancelar</a>
