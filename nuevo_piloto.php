...
<div class="content-page">
	<div class="content">
		<div class="container">
            <div class="row">
				<div class="col-sm-12">
					<h4 class="page-title">Nuevo Piloto</h4>
					<ol class="breadcrumb">
                        <li><a href="index.php">Panel</a></li>
                        <li><a href="pilotos.php">Pilotos</a></li>
						<li class="active">Nuevo Piloto</li>
					</ol>
				</div>
			</div>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input type="text" name="inputNombre" class="form-control" placeholder="Ingresar datos">
                                    </div>
                                    <div class="form-group m-b-20">
                                        <label>Apellido<span class="text-danger">*</span></label>
                                        <input type="text" name="inputApellido" class="form-control" placeholder="Ingresar datos">
                                    </div>
                                    <div class="form-group m-b-20">
                                        <label>Telefono<span class="text-danger">*</span></label>
                                        <input type="text" name="inputTelefono" class="form-control" placeholder="Ingresar datos">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input type="text" name="inputDireccion" class="form-control" placeholder="Ingresar datos">
                                    </div>
                                    <div class="form-group m-b-20">
