                                            ...
                                            <div class="col-lg-6">
                                                <div class="card-box">
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="text" class="form-control" name="inputNombre" placeholder="Ingresar nombre">
                                                    </div>

                                                    <div class="form-group m-b-20">
                                                        <label>Descripcion Producto <span class="text-danger">*</span></label>
                                                        <textarea class="form-control" name="inputDescripcion" rows="5" placeholder="Ingresa una descripcion"></textarea>
                                                    </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card-box">
                                                    ...
                                                    <div class="form-group m-b-20">
                                                        ...
                                                        <input type="text" name="inputPrecio" class="form-control" min="0" step="0.01" placeholder="Q 00.00">
                                                    </div>
