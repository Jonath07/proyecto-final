...
require 'vendor/autoload.php';
    ...
    $infoRuta = $clase->mostrarPorID($_GET['id']);
?>
...
<div class="content-page">
	<div class="content">
		<div class="container">
            <div class="row">
				<div class="col-sm-12">
					<h4 class="page-title">Editar Ruta</h4>
					<ol class="breadcrumb">
                            ...
                            <div class="col-lg-6">
                                <div class="card-box">
                                    ...
                                    <div class="form-group m-b-20">
                                        ...
                                        <input type="text" name="inputCodigo" class="form-control" value="<?php echo $infoRuta['codigo_ruta'] ?>">
                                        <input type="hidden" name="inputID" class="form-control" value="<?php echo $infoRuta['id_ruta'] ?>">
                                    </div>
                                    <div class="form-group m-b-20">
                                        <label>Referencia Ruta<span class="text-danger">*</span></label>
                                        <input type="text" name="inputReferencia" class="form-control" value="<?php echo $infoRuta['referencia_ruta'] ?>">
                                    </div>
